...
class EscalonadorProcessos:
    """
    Simulador de escalonamento de processos com filas de prioridade e I/O.
    
    Implementa algoritmo de escalonamento com:
    ...
    - Ciclo extra para finalização de processo
    """
    ...
    def carregar_processos(self, nome_arquivo):
        ...
        Formato esperado: id;tempoEntrada;tempoIO;tempoProcesamento;prioridade
        """
        try:
            ...
            # Ordena por tempo de entrada para facilitar a simulação
    ...
    def _verificar_chegada_processos(self):
        """Verifica e processa chegada de novos processos no tempo atual."""
        ...
        # Remove processos que já entraram
    ...
    def _executar_ciclo_cpu(self):
        """
        Executa uma fatia de processamento na CPU.
        
        Lógica pós-processamento:
        - Se CPU=0 e I/O=0: finaliza processo (+ 1 ciclo extra)
        - Se I/O>0: move para fila de I/O
        - Se CPU>0 e I/O=0: volta para fila de processamento
        """
    ...
    def _executar_ciclo_io(self):
        """
        Executa uma fatia de I/O.
        
        Lógica pós-I/O:
        - Se CPU=0 e I/O=0: move para CPU para finalização
        - Se CPU>0: volta para fila de processamento
        - Se I/O>0 e CPU=0: continua na fila de I/O
        """
    ...
    def executar(self):
        ...
        # Loop principal: continua enquanto houver processos pendentes
        ...
        # Ordena resultados por tempo de saída
        self.processos_finalizados.sort(key=lambda item: item[0])

    def salvar_resultado(self, nome_arquivo_saida):
        """
        Salva resultados da simulação no formato: tempoDeSaida;idProcesso
        """
